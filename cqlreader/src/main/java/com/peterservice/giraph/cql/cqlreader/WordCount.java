package com.peterservice.giraph.cql.cqlreader;
...
public class WordCount extends Configured implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        else
        {
            ...
            ConfigHelper.setOutputInitialAddress(job.getConfiguration(), "SRV2-ITSD03");
        ...
        ConfigHelper.setInputInitialAddress(job.getConfiguration(), "SRV2-ITSD03");
